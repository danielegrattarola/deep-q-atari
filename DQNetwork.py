...
class DQNetwork:
    def __init__(self, actions, input_shape, minibatch_size=32,
        ...
        self.model.add(
            Convolution2D(32, 8, 8, border_mode='valid', subsample=(4, 4), input_shape=input_shape, dim_ordering='th'))
    ...
    def train(self, batch, DQN_target):
        ...
        for datapoint in batch:
            ...
            t[datapoint['action']] = (datapoint['reward'] + self.discount_factor * next_Q_value) if not datapoint[
                'final'] else datapoint['reward']
